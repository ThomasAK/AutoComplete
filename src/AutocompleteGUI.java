...
public class AutocompleteGUI extends JFrame {
    ...
    public AutocompleteGUI(String filename, int k) {
        ...
        layout.setHorizontalGroup(
                ...
                .addGroup(layout.createParallelGroup(
                        ...
                        .addComponent(checkbox, GroupLayout.DEFAULT_SIZE,
                                GroupLayout.DEFAULT_SIZE,
                                GroupLayout.PREFERRED_SIZE))
    ...
    private class AutocompletePanel extends JPanel {
        ...
        //Def_Columns not needed with how i fixed the resizing
        //private final int DEF_COLUMNS = suggListLen.length();
        ...
        public AutocompletePanel(String filename) {
            ...
            searchText = new JTextField(DEF_WIDTH);
            ...
            suggestions.setPrototypeCellValue(new Dimension(150, 30));
            suggestions.setFont(
            ...
            searchText.addComponentListener(new ComponentAdapter() {
